...
public class SignUpFragment extends Fragment implements OnClickListener {
	...
	private void initViews() {
		fullName = (EditText) view.findViewById(R.id.edit_firtname);
		emailId = (EditText) view.findViewById(R.id.edit_email);
		mobileNumber = (EditText) view.findViewById(R.id.edit_phone);
		location = (EditText) view.findViewById(R.id.edit_city);
		password = (EditText) view.findViewById(R.id.edit_password);
		confirmPassword = (EditText) view.findViewById(R.id.edit_password_confirmation);
